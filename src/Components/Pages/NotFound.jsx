        ...
        <div className="relative flex items-center justify-center min-h-screen overflow-hidden bg-[#f8fafc]">
            ...
            <div className="relative z-10 text-center px-6">
                <div className="relative inline-block">
                    <h1 className="text-[12rem] md:text-[16rem] font-black leading-none tracking-tighter text-slate-900 opacity-[0.04]">404</h1>
                    <div className="absolute inset-0 flex items-center justify-center">
                        <h2 className="text-6xl md:text-8xl font-black bg-linear-to-b from-slate-800 to-slate-500 bg-clip-text text-transparent">Oops!</h2>
                    </div>
                </div>
                ...
                <div className="max-w-md mx-auto -mt-4 md:-mt-8">
                    ...
                    <div className="mt-16 pt-8 border-t border-slate-200/60">
                        <p className="text-sm text-slate-400 mb-4 font-medium uppercase tracking-widest">Need help?
                        </p>

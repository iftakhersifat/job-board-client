...
const MoreDetails = () => {
    ...
    return (
        <div className='max-w-6xl mx-auto px-6 md:px-6 lg:px-0 mt-24'>
            <div className="group relative border border-transparent bg-gradient-to-br from-white via-blue-50 to-blue-100 hover:from-blue-100 hover:to-white rounded-2xl p-6 h-[580px] md:h-[520px] flex flex-col justify-between shadow-md hover:shadow-xl transition-all duration-500 hover:-translate-y-1">
  {/* Top Gradient Accent */}
  ...
  <div className="flex justify-between items-center mb-4">
    <div className="flex gap-4 items-center">
      <div className="w-16 h-16 bg-white border border-gray-200 rounded-xl flex items-center justify-center overflow-hidden shadow-sm">
        <img
      ...
      <div>
        ...
        <p className="text-sm text-gray-500 flex items-center gap-1">
          <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 20.25c4.97 0 9-3.806 9-8.5 0-4.694-4.03-8.5-9-8.5s-9 3.806-9 8.5c0 4.694 4.03 8.5 9 8.5z" />
          </svg>
          {job.location}
        </p>
      </div>
    </div>
    <button className="px-4 py-2 bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 text-white rounded-lg text-sm font-medium shadow hover:shadow-md transition-all duration-200">
      {job.jobType}
    </button>
  </div>
  ...
  <div className="flex-1 space-y-4">
    <h2 className="font-bold text-2xl text-gray-800 group-hover:text-blue-700 transition-colors">
      {job.title}
    </h2>
  ...
  <div className="mt-4 text-right">
    <button className="bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 hover:from-blue-700 hover:via-indigo-700 hover:to-purple-700 text-white px-6 py-2.5 rounded-lg font-semibold  shadow-md hover:shadow-lg transition-all duration-300">Apply Now
    </button>
  </div>
</div>
